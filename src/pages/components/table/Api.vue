      ...
      apiSource: [
        {
          key: 0,
          param:
            '<a href="https://www.antdv.com/components/table-cn/#API" target="_blank">Ant Design Vue Table API</a>',
      ...
      events: [
        {
          key: 0,
          param:
            '<a href="https://www.antdv.com/components/table-cn/#API" target="_blank">Ant Design Vue Table Events API</a>',
        ...
        },
        {
          ...
          desc: '搜索条件变化时触发',
          callback:
            'Function(conditions, searchOptions: [{field, value, format}])'
        },
        {
          key: 2,
          param: 'refresh',
      ...
      columnApi: [
        {
          key: 0,
          param:
            '<a href="https://www.antdv.com/components/table-cn/#API" target="_blank">Ant Design Vue Table Column API</a>',
